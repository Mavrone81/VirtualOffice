    ...
    <Card className="max-w-md p-5">
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-[12px] text-muted-2">At least 8 characters.</p>
        </div>
        <div>
        ...
        {done && <p className="rounded-lg bg-success-50 px-3 py-2 text-[13px] text-success">✓ Password updated.</p>}
