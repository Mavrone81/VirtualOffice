...
export function Topbar({ user, period, onMenu }: { user: ShellUser; period: string; onMenu: () => void }) {
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-line bg-paper/85 px-4 backdrop-blur lg:px-6">
      <button onClick={onMenu} aria-label="Open menu" className="rounded-md p-2 text-ink hover:bg-paper-200 lg:hidden">
      ...
      <div className="relative hidden max-w-md flex-1 sm:block">
        ...
        <input
          placeholder="Search associates, sales, invoices…"
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <button aria-label="Notifications" className="relative rounded-md p-2 text-ink hover:bg-paper-200">
