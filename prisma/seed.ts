...
async function main() {
  ...
  const assocDefs: A[] = [
    ...
    { code: "EN0003", fullName: "Jennifer Rk (Uma Devi Raja Krishnan)", businessName: "Jennifer Rk", mobile: "87422156", email: "uma.devi.jennifer@gmail.com", nric: "S7703318A", dob: "1977-01-29", designation: Designation.SalesConsultant, uplineCode: "EN0002", team: "Vincent Lim Division", approval: ApprovalStatus.Approved, status: AssociateStatus.Active, role: AppRole.Consultant },
    { code: "EN0004", fullName: "Lee Jong Seng", businessName: "John Lee", mobile: "97323288", email: "johnlee@mobilebellator.com", nric: "S6807723J", dob: "1968-02-20", designation: Designation.SalesConsultant, uplineCode: "EN0002", team: "Vincent Lim Division", approval: ApprovalStatus.Approved, status: AssociateStatus.Active, role: AppRole.Consultant },
    { code: "EN0005", fullName: "Lim Wai Lee", mobile: "82001390", email: "limwailee8200@gmail.com", nric: "S7013454C", dob: "1979-04-27", designation: Designation.SalesConsultant, uplineCode: "EN0002", team: "Vincent Lim Division", approval: ApprovalStatus.Approved, status: AssociateStatus.Active, role: AppRole.Consultant },
    { code: "EN0006", fullName: "Yan Bai Xiang", mobile: "87685469", email: "alexsyanbaixiang@gmail.com", nric: "S9019702I", dob: "1990-06-04", designation: Designation.SalesConsultant, uplineCode: "EN0002", team: "Vincent Lim Division", approval: ApprovalStatus.Pending, status: AssociateStatus.Inactive },
